...
docker run -e JSON_CREDS="$JSON_CREDS" -e SPX_INFO_GDRIVE="$SPX_INFO_GDRIVE" -e SPX_PRICES_GDRIVE="$SPX_PRICES_GDRIVE" -e SPX_FINANCIALS_GDRIVE="$SPX_FINANCIALS_GDRIVE" spx_13_source_financials_gdrive
